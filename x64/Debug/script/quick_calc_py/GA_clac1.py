...
for ii in range(n_layer):
    ...
    para_u[ii*2] = content["model_meta"][ii]["para"]["d_max"]+1e-3
    para_l[ii*2+1] = content["model_meta"][ii]["para"]["e_min"]
    para_u[ii*2+1] = content["model_meta"][ii]["para"]["e_max"]+1e-3
...
Fit_X_pltd=Fit_X.values[:,4]
Fit_X_plte=Fit_X.values[:,5]
